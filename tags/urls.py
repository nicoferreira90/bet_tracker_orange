...
htmx_urlpatterns = [
    path("delete_tag/<uuid:pk>/", delete_tag_view, name="delete_tag"),
    path(
        "remove_associated_tag/<uuid:pk>/",
        remove_associated_tag,
        name="remove_associated_tag",
    ),
    path(
        "add_associated_tag/<uuid:pk>/", add_associated_tag, name="add_associated_tag"
    ),
]
