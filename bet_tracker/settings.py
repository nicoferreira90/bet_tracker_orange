...
EMAIL_BACKEND = (
    "django.core.mail.backends.smtp.EmailBackend"  # new. SMTP now instead of console.
)
...
SENDGRID_API_KEY = env(
    "SENDGRID_API_KEY",
    default="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",
)  # default is just an old obsolete key
